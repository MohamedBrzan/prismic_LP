...
export interface BentoSliceDefaultItem {
  ...
  /**
   * description field in *Bento → Items*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.items[].description
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  description: prismic.RichTextField;
 ...
 */
export interface IntegrattionsSliceDefaultPrimary {
  /**
   * Heading field in *Integrations → Primary*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
   * - **API ID Path**: integrattions.primary.heading
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  heading: prismic.TitleField;
   ...
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: integrattions.primary.body
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  body: prismic.RichTextField;
}
 ...
 */
export interface IntegrattionsSliceDefaultItem {
  /**
   * Icon field in *Integrations → Items*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: integrattions.items[].icon
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type IntegrattionsSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<IntegrattionsSliceDefaultPrimary>,
  Simplify<IntegrattionsSliceDefaultItem>
>;

/**
 * Slice variation for *Integrations*
 */
type IntegrattionsSliceVariation = IntegrattionsSliceDefault;

/**
 * Integrations Shared Slice
 *
 * - **API ID**: `integrattions`
 * - **Description**: Integrattions
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type IntegrattionsSlice = prismic.SharedSlice<
  "integrattions",
  IntegrattionsSliceVariation
>;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      HeroSliceDefault,
      IntegrattionsSlice,
      IntegrattionsSliceDefaultPrimary,
      IntegrattionsSliceDefaultItem,
      IntegrattionsSliceVariation,
      IntegrattionsSliceDefault,
      RichTextSlice,
